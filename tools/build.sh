...
#
#  echo "RumbleDB version: $rumble_major"
#  echo "$rumble_minor"
#  echo "$rumble_patch"
...
#fi
  rumble_url="https://github.com/RumbleDB/rumble/releases/download/v1.21.0/rumbledb-1.21.0-for-spark-3.4.jar"
